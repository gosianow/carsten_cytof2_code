...
###############################################################################################################
# Analysis of MyeEUNITERfinal_noPatient1 data
# Use Analysis block 1
###############################################################################################################

### Copy the fcs from MyeEUNITERfinal/010_cleanfcs/ into MyeEUNITERfinal_noPatient1/010_cleanfcs/

# mkdir -p $RWD_MAIN/MyeEUNITERfinal_noPatient1/010_cleanfcs
# cp $RWD_MAIN/MyeEUNITERfinal/010_cleanfcs/*.fcs $RWD_MAIN/MyeEUNITERfinal_noPatient1/010_cleanfcs/


data_dir="MyeEUNITERfinal_noPatient1"
...
# --------------------------------------------------
# Analysis of MyeEUNITERfinal_noPatient1 cluster_merging
# Use Analysis block 2
# --------------------------------------------------
...
# --------------------------------------------------
# MyeEUNITERfinal_noPatient1 - neutrophils and monocytes cluster extracting from merging
# Use Analysis block 3
# --------------------------------------------------
...
extract_cluster="c('neutrophils','monocytes')"
extract_dir="MyeEUNITERfinal_noPatient1_neutrophils_merging"
...
# --------------------------------------------------
# Analysis of MyeEUNITERfinal_noPatient1_neutrophils_merging
# Use Analysis block 1
# --------------------------------------------------
...
data_dir='MyeEUNITERfinal_noPatient1_neutrophils_merging'
prefix_data='myefnoP1NEUTROP_'
file_panel='panel_MyeEUNITERfinal.xlsx'
prefix_panel='myef_'
pca_score_cutoff=0
...
# --------------------------------------------------
# Analysis of MyeEUNITERfinal_noPatient1_neutrophils_merging cluster_merging
# Use Analysis block 2
# --------------------------------------------------
